...
public abstract class DateUtil {
	...
	public static final String DATE_FORMATTER_HMS_S = "yyyy-MM-dd HH:mm:ss.S";
	public static final String DATEFORMATTERHMS = "yyyyMMddHHmmss";
	 ...
	 * @return
	 */
	public static String dateFormatTostr(java.util.Date date, String format) {
		if (date == null)
			return "";
		try {
	 ...
	 * @param date
	 */
	static public String dateTime2str(Timestamp date) {
		if (date == null)
			return "";
		try {
			return MMddYYYY_HHmmss.format(date);
	...
	public static java.util.Date formatStrToDateByLength(String dateStr) {
		...
		try {
			...
			}if(strLength==DATE_FORMATTER_HMS_S.length()){
				dateFormat = DATE_FORMATTER_HMS_S;
			}
	...
	public static String getTimeByMinute(int minute, java.util.Date date){
		Calendar calendar= Calendar.getInstance();
	...
	public static String getTimeByHour(int hour, java.util.Date date){
		Calendar calendar= Calendar.getInstance();
		calendar.setTime(date);
	...
	public static String getAllowPreMonthDay(java.util.Date date, int count){
		Calendar calendar= Calendar.getInstance();
		calendar.setTime(date);
		calendar.add(Calendar.MONTH, -count);
		return dateFormatTostr(calendar.getTime(), "yyyy-MM-dd");
	}

	//判断时间是否在一年内
	public static boolean getCompareDate(String dateStr, int count){
		boolean resout=false;
		try {
			String lastYear=getAllowPreMonthDay(new java.util.Date(),count);
			dateStr=dateStr.substring(0,10);
			Long str1 = str2date(lastYear).getTime();
			Long str2 = str2date(dateStr).getTime();
	...
	//判断布控结束时间和当前时间比对判断是否有效
	public static boolean getCompareDate1(String dateStr){
		boolean resout=false;
		try {
			//当前时间
			Long str1 = new java.util.Date().getTime();
			//比对时间
			Long str2 = str2date(dateStr).getTime();
	...
	public static void main(String[] args) {
		System.out.println(getTimeByHour(-24,new java.util.Date()));
	/*	Long time =System.currentTimeMillis();
		System.out.println(dateFormatTostr(new Date(time),DATE_FORMATTER_HMS));
		time +=4*60*1000*60;
		*//*System.out.println(new Date(time));*//*

		System.out.println(dateFormatTostr(new Date(time),DATE_FORMATTER_HMS));*/

		/*System.out.println(getAllowPreDay("2018-4-27 09:47:11.0",12));

		System.out.println(getTimeByHour(0,new java.util.Date()));
		System.out.println(getTimeByHour(-24*30,new java.util.Date()));*/

		System.out.println(getToDayCountInfo(3));
		System.out.println(getToDayCountResult(-7));
		System.out.println(getToDayCountResult(0));
	}
	...
	public  static String getTodayLastday(){
		String day = dateFormatTostr(new java.util.Date(),DATE_FORMATTER_HMS);
		return day.substring(0,10)+" 23:59:59";
	}
	/*获取必当前时间小count 的日期*/
	public static String getToDayCount(int count){
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.DAY_OF_YEAR, calendar.get(Calendar.DAY_OF_YEAR) - count);
		java.util.Date today = calendar.getTime();
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		return  format.format(today) ;
	}

	public static String getToDayCountInfo(int count){
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.DAY_OF_YEAR, calendar.get(Calendar.DAY_OF_YEAR) + count);
		java.util.Date today = calendar.getTime();
		SimpleDateFormat format = new SimpleDateFormat(DATEFORMATTERHMS);
		return  format.format(today) ;
	}

	public static String getToDayCountResult(int count){
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.DAY_OF_YEAR, calendar.get(Calendar.DAY_OF_YEAR) + count);
		java.util.Date today = calendar.getTime();
		SimpleDateFormat format = new SimpleDateFormat(DATE_FORMATTER_HMS);
		return  format.format(today) ;
	}
	/**
	 * 获取当前月的第一天
	...
	public  static String getMonthStartday(){
		String day = dateFormatTostr(new java.util.Date(),DATE_FORMATTER_HMS);
		return day.substring(0,8)+"01 00:00:00";
	}
